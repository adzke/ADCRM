                ...
                <Table className={classes.table} aria-label="simple table">
                    ...
                    .map((row) => (
                        ...
                        <Box display="flex" flexDirection="row">
                                <Box p={1} >
                                <Avatar className={classes.orange}>{row.company_name.slice(0,1)}</Avatar>
                                </Box>
                            
                                <Box p={1} >
                                  
                                <Typography className={classes.title} color="inherit" variant="h6" component="div"> {row.company_name}</Typography>
